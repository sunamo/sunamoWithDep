...
public partial class SF
{
    ...
    public static void RemoveComments(List<string> tf)
    {
 ...
 Dictionary<T1, T2>(string file, Dictionary<T1, T2> artists)
    {
        ...
        await
#endif
        TF.WriteAllText(file, sb.ToString());
    }
 ...
 DictionaryAppend(string v, Dictionary<int, string> toSave)
    {
        ...
        await
#endif
        TF.AppendAllText(v, sb.ToString() + Environment.NewLine);
    }
}
