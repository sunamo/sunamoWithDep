 ...
 */
    ...
    {
        private static List<string> s_shops = new List<string>(CAG.ToList<string>("mulac.cz", "solar-eshop.cz", "karavan3nec.cz", "campi-shop.cz", "ges.cz", "dstechnik.cz", "emerx.cz", "vpcentrum.eu", "dexhal.cz"));
    ...
    public static partial class SpiceMarks
    {
        ...
        public static void SearchInAll(string spicyName)
        {
            if (s_list == null)
            {
                s_list = new List<string>(CAG.ToList<string>("kotanyi", "avok\u00E1do", "nadir", XlfKeys.Orient, XlfKeys.Drago, "v\u00EDtana", "sv\u011Bt bylinek"));
            }
